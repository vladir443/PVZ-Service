...
export async function sendEmailCode({ email, code }) {
  ...
  const info = await getTransporter().sendMail({
    ...
    to: recipient,
    subject: "Код для входа в PVZ Group",
    text: `${code} — код для входа на pvzgroup.ru. Код действует 10 минут. Никому не сообщайте его.`,
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto;padding:28px;color:#14213d">
        <h1 style="font-size:24px;margin:0 0 12px">Вход в PVZ Group</h1>
        <p style="margin:0 0 22px;color:#64748b">Введите этот код на сайте:</p>
